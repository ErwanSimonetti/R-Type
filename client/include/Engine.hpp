...
class Engine {
    public:
        ...
        void create_friendly_entity(sf::Color col, const uint16_t velX, const uint16_t velY, const uint16_t posX, const uint16_t posY);
        ...
        void create_enemy_entity(sf::Color col, const uint16_t velX, const uint16_t velY, const uint16_t posX, const uint16_t posY);
        
        /// @brief Generate a projectile
        /// @param parentShipId 
        /// @param col 
        /// @param velX 
        /// @param velY 
        /// @return 
        void create_projectile(entity parentShip, sf::Color col, const uint16_t velX, const uint16_t velY, const uint16_t damage);
