...
class Engine {
    public:
         ...
         */
        Engine(boost::asio::io_service &io_service, const std::string &host, const std::string &port, const std::string &graphicModulePath, const std::string &gameModulePath);
        ~Engine();
         ...
         */
        void updateRegistry(char *message);
